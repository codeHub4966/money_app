...
class PinScreenState extends State<PinScreen> with SingleTickerProviderStateMixin {
  String _pin = '';
      ...
      AnimatedBuilder(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: _showError ? Border.all(color: Colors.red, width: 2) : null,
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: List.generate(4, (i) => Container(
            ...
            decoration: BoxDecoration(
              ...
              color: _showError
                ? Colors.red
                : (i < _pin.length ? AppTheme.primary : AppTheme.surfaceContainerHigh),
            ),
          ))),
        ),
      ),
          ...
          if (widget.showBiometricButton)
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(Icons.fingerprint, size: 32, color: AppTheme.primary),
              ),
            )
          else
